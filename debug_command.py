...
command = f"cd {PROJECT_PATH} && export NVM_DIR=\"$HOME/.nvm\" && [ -s \"$NVM_DIR/nvm.sh\" ] && . \"$NVM_DIR/nvm.sh\" && stdbuf -oL -eL node shannon.mjs generate {target} --no-ai 2>&1"

print("Команда:")
print(command)
print("\n" + "="*60)
print("Выполнение (первые 100 строк):")
print("="*60 + "\n")
